...
public class WxMenuController {
    ...
    public String menuCreateSample(@PathVariable String index) throws WxErrorException, MalformedURLException {
        ...
        if(index.equals("0")) {
            ...
            login.setName("购买服务");
            login.setKey("BUY");
            login.setType(MenuButtonType.VIEW);
            WxContent wxContent = wxContentMapper.selectOne(new QueryWrapper<WxContent>().eq("type", "msb_buy_url"));
            login.setUrl(wxContent.getContent());
            /*关于我们*/
        ...
        if(index.equals("1")) {
            ...
            web.setName("福利网站");
            web.setKey("FULIWEB");
            web.setUrl("https://www.youyou666.vip");

            /*购买链接*/
            WxMenuButton buy = new WxMenuButton();
            buy.setType(MenuButtonType.VIEW);
            buy.setName("购买服务");
            buy.setKey("BUY");
            buy.setUrl("https://www.happain.cn/buy");
            /*登陆业务*/
