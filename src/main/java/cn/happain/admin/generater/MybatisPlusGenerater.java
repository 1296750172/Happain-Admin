...
public class MybatisPlusGenerater {
    static String url ="jdbc:mysql://127.0.0.1:3306/happain-admin?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
